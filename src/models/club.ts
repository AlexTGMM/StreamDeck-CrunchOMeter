...
/*
    This file is auto-generated by AI using a sample message.  The types may not be completely correct,
    but it'll be easy enough to fix them by hand as needed.
*/
